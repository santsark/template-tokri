...
export default function DeliveryPolicyPage() {
  return (
    <PolicyPage title="Delivery Policy">
      ...
      <p>First draft is typically delivered within 3–5 business days of receiving the advance payment and all required details. During peak seasons (e.g. Durga Puja, wedding season) we'll proactively inform you of any longer timeline.</p>
      ...
      <h2>Contact us</h2>
      <p>For any delivery questions: hello@templatetokri.in</p>
    </PolicyPage>
  );
}