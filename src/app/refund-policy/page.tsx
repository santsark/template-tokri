...
export default function RefundPolicyPage() {
  return (
    <PolicyPage title="Refund Policy">
      ...
      <p><strong>How to request:</strong> Email or WhatsApp us within [FILL IN — e.g. 3 days] of purchase with your order ID.</p>
      ...
      <p>[FILL IN — e.g. 2] rounds of revisions are included; additional revisions may carry an extra charge, communicated before starting.</p>

      <h2>General</h2>
      <p>Refunds are issued to the original payment method via Razorpay. Processing typically takes [FILL IN] business days depending on your bank/UPI provider.</p>
    </PolicyPage>
  );
}